 ...
 *	@version $Id: MTH_PR_Bid. 
 */
public class MTH_PR_Bid extends X_TH_PR_Bid implements DocAction {

	public MTH_PR_Bid(Properties ctx, int id, String trxName) {
	...
	public MTH_PR_Bid(Properties ctx, ResultSet rs, String trxName) {
